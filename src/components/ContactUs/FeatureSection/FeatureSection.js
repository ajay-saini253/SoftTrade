 ...
 const accordionData = [
  {
    ...
    content:
      "SoftTrade ERP accelerates deployment with ready-to-use modules for inventory, sales, finance, and HR. Businesses can go live faster and start seeing operational benefits in days—not months."
  },
  {
  ...
  },
  {
    ...
    content:
      "With a centralized platform, SoftTrade ERP reduces the need for multiple disconnected systems. Automation cuts operational overhead, minimizes errors, and helps avoid costly delays or rework."
  },
  {
    title: "Boost Customer Satisfaction",
    content:
      "By streamlining order management, inventory tracking, and after-sales support, SoftTrade ERP helps businesses respond faster to customer needs—resulting in higher trust and satisfaction."
  }
];


    return (
        <section className="feature pb-50 pt-50" style={{ background: "#f9f9f9" }}>
                            ...
                            <div className="feature-right-item mt-30">
                                <div className="sec-title--two sec-title--four mb-40">
                                    <Fade direction='down' triggerOnce={false} duration={1500} delay={9}>
                                        <div>
                                            <h2 className="title mb-15">How Can SoftTrade Help?</h2>
                                        </div>
                                    </Fade>
                                   <p>Save time, reduce operational costs, and boost productivity with SoftTrade ERP. Businesses have reported faster workflows, improved accuracy, and significant ROI within the first year of implementation.</p>
                                 </div>
