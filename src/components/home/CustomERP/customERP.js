                    ...
                    <div className="row align-items-center">
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-12'>
                            ...
                            <Fade direction='up' triggerOnce={false} duration={1800} delay={9}>
                                <h3 className="text-black">What You Can Expect :</h3>
                                <ul className="list-unstyled mt-3">
                                    <li className="d-flex align-items-start mb-2">
                                        <img src={icon1} alt="check" className="me-2" />
                                       <div  > 
                                        <h5 className="text-black mb-1 d-inline-block">Guaranteed Assistance :- </h5>
                                        <span className="text-gray mb-0">
                                    ...
                                    <li className="d-flex align-items-start mb-2">
                                        <img src={icon1} alt="check" className="me-2" />
                                        <div  > 
                                        <h5 className="text-black mb-1 d-inline-block">Multiple Support Channels :- </h5>
                                        <span className="text-gray mb-0">
                                    ...
                                    <li className="d-flex align-items-start mb-2">
                                        <img src={icon1} alt="check" className="me-2" />
                                       <div  > 
                                        <h5 className="text-black mb-1 d-inline-block">Expert Technical Team :- </h5>
                                        <span className="text-gray mb-0">
                                    ...
                                    <li className="d-flex align-items-start mb-2">
                                        <img src={icon1} alt="check" className="me-2" />
                                       <div  > 
                                        <h5 className="text-black mb-1 d-inline-block">Real-Time Remote Support :- </h5>
                                        <span className="text-gray mb-0">
