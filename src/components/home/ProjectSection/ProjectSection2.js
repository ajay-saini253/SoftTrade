...
const ProjectSection2 = (props) => {
    ...
    return (
       <section
  className="project o-hidden  pt-100 pb-120 home_project-gradient">
                                        ...
                                        <div className="xb-item--inner ul_li_between pos-rel z-1">
                                            <div className="xb-item--project_title">
                                                ...
                                                <div className="xb-btn mt-50">
                                                    <Link onClick={ClickHandler} to={`/portfolio_details/${project.slug}`} className="thm-btn thm-btn--border">View {project.title}<span><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
