...
const Process = [
    {
        ...
        subTitle: 'At SoftTrade, we begin by understanding your business processes to identify ERP requirements that align with your goals.',
        icon: sIcon1,
        direction: 'one',
    },
    {
    ...
    },
    {
        ...
        subTitle: 'SoftTrade deploys the ERP system with full support and provides continuous assistance and upgrades post-launch.',
        icon: sIcon5,
        direction: 'four',
    },
];
