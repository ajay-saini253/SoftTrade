    ...
    return (
        <section className="blog_details_section pt-70">
            <div className="container">
                    ...
                    <div className="row">
                            ...
                            <ul className="post_meta list-unstyled ul_li">
                                <li>
                                    <Link onClick={ClickHandler} to={'/blog'}>
                                        ...
                                        <span className="meta_label">{BlogDetails.author}</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link onClick={ClickHandler} to={'/blog'}>
                                        ...
                                        <span className="meta_label">{BlogDetails.comment}</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link onClick={ClickHandler} to={'/blog'}>
                        ...
                        <div className="col-md-6">
                            <ul className="post_meta list-unstyled ul_li justify-content-md-end">
                                <li>
                                    <Link onClick={ClickHandler} to={`/blog-single/${BlogDetails.slug}`}>
                                        <span className="meta_icon">
                ...
                <div className="row mt-none-30 g-0 align-items-start">
                    <div className="col-lg-8 mt-30">
                        <div className="blog_details_content">
                            ...
                            <p>Gain exclusive insights into the world of IT solutions with SoftTrade distinguished thought leaders. With years of experience and a deep understanding of industry trends, our thought leaders offer invaluable perspectives that illuminate the path to technological excellence. From emerging technologies to innovative strategies, they provide unique insights that inform and inspire. Join us as we delve into the inner workings of IT solutions, exploring the challenges.</p>
                            <p>Embark on an illuminating journey into the world of IT solutions with SoftTrade esteemed thought leaders. Delve deep into the inner workings of technology as our seasoned experts share their wealth of knowledge and experience. With a finger on the pulse of industry trends and a keen eye for innovation, our thought leaders offer unparalleled insights that illuminate the path</p>
                ...
                <div className="related-blog pt-50 pb-80">
