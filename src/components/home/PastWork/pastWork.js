...
const PastWorks = [
    {
        ...
        tImg: tImg1,
        logo: icon1,
        Des: "Working with SoftTrade was fantastic! Their strategies improved our rankings and increased leads.",
    ...
    },
    {
        ...
        tImg: tImg2,
        logo: icon2,
        Des: "SoftTrade exceeded all our expectations! Their expertise in SEO helped us achieve a remarkable 150%",
        Name: 'Simple',
        sub: 'Invoicing',
    },
    {
        ...
        tImg: tImg3,
        logo: icon3,
        Des: "Choosing SoftTrade was a great decision. Their focus on trends helped us rank for competitive keywords.",
        Name: 'Quick',
        sub: 'Payments',
    },
    {
        ...
        tImg: tImg4,
        logo: icon4,
        Des: "Since partnering with SoftTrade, our website's performance has improved remarkably.",
        Name: 'Regular',
        sub: 'Updates',
    },
    {
