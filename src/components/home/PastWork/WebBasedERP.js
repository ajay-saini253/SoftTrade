                  ...
                  <div className="col-lg-3">
                    ...
                    <div className="erp-benefits-cards text-start">
                      ...
                      <ul>
                       ...
                       {/* <li className="text-black"><img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Proactive corrective measures</li> */}
                      </ul>
                    </div>
                  </div>
                    ...
                    <img src={cta2} alt="Slide 2" className="webbaseerp-slider-image" />
                     <div className="erp-benefits-cards text-start  mx-5">
                      ...
                      <ul>
                       ...
                       {/* <li className="text-black"> <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Better compliance monitoring</li> */}
                      </ul>
                    </div>
                  ...
                  <div className="col-lg-3">
                    <div className="erp-benefits-cards text-start mb-4">
                      ...
                      <ul>
                       ...
                       {/* <li className="text-black"> <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Regulatory adherence</li>
                       <li className="text-black"> <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Better compliance monitoring</li> */}
                      </ul>
                    </div>
                    <div className="erp-benefits-cards text-start mb-4">
                      ...
                      <ul>
                       ...
                       {/* <li className="text-black"> <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Lower manufacturing costs</li>
                       <li className="text-black"> <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Improved bottom line</li> */}
                      </ul>
                    </div>
                    <div className="erp-benefits-cards text-start mb-4">
  ...
  <SwiperSlide>
    <div className="erp-benefits-cards text-start p-3 shadow rounded erp-benefits-cards-mobile">
      ...
      <ul>
        ...
        {/* <li className="text-black">
          <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Proactive corrective measures
        </li> */}
      </ul>
    </div>
  </SwiperSlide>
...
<SwiperSlide>
  <div className="erp-benefits-cards text-start p-3 shadow rounded erp-benefits-cards-mobile">
    ...
    <ul>
      ...
      {/* <li className="text-black">
        <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Lower manufacturing costs
      </li>
      <li className="text-black">
        <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Improved bottom line
      </li> */}
    </ul>
  </div>
</SwiperSlide>
...
<SwiperSlide>
  <div className="erp-benefits-cards text-start p-3 shadow rounded erp-benefits-cards-mobile">
    ...
    <ul>
      ...
      {/* <li className="text-black">
        <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Increased sales
      </li>
      <li className="text-black">
        <img src={icon1} alt="check" className="erp-benefits-cards-img me-2" /> Higher profit margins
      </li> */}
    </ul>
  </div>
</SwiperSlide>
