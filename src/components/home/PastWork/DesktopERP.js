...
const DesktopERP = (props) => {
  ...
  return (
    <section className="cta  pos-rel z-1 pt-50 pb-50 o-hidden" style={{
      ...
      <div className="container">
        <div class="row justify-content-center align-items-center text-center">
          ...
          <div className='col-lg-6 col-md-12 col-sm-12 my-2 '>
           ...
           SoftTrade offers a powerful Desktop software designed for businesses that prefer local installation and offline accessibility.
            </p>
