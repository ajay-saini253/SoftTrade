                              ...
                              <div className="col-lg-12">
                                <div className="px-3 py-3">
                                  <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                      <div className="megamenu_case megamenu_case1">
                                        <h3 className="text-black">{resourcesMenuContent[selectedResources]?.title || 'SoftTrade Training'}</h3>
                                        <h4 className="text-black">{resourcesMenuContent[selectedResources]?.heading || 'SoftTrade Training'}</h4>
                                        <img
