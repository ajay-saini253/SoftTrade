...
const [selectedResources, setSelectedResources] = useState('resources'); 
  ...
  const aboutMenuContent = {
   ...
   const resourcesMenuContent = {
    ...
    beta: {
      title: 'BETA Program',
      heading: 'SoftTrade BETA Program',
      image: customerImg,
      link: '/beta-program',
    },
    blog: {
      title: 'Blog',
      heading: 'SoftTrade Blog',
      image: awardsImg,
      link: '/blog',
    },
        ...
        <small className="iconbox_title">Career & Job</small>
                                    ...
                                    <div className="col-lg-6">
                                      <div className="megamenu_case megamenu_case1">
                                        ...
                                        <img src={aboutMenuContent[selectedAbout].image} alt={selectedAbout} width={300} />
                                        <Link onClick={clickHandler} className="megamenu_btn megamenu_btn_about text-center text-black rounded" to={aboutMenuContent[selectedAbout].link}>
                                          Read More
                                    ...
                                    <div className="row g-10">
                                      <div className="col-xl-4 col-md-4">
                                        <Link onClick={clickHandler} className="iconbox_block_2" to="/about">
                                          ...
                                          <span className="description mb-0">Learn more about SoftTrade</span>
                                        </Link>
                                      </div>
                                      <div className="col-xl-4 col-md-4">
                                    ...
                                    <div className="site_author">
                                      <div className="author_box">
                                        ...
                                        <div className="author_box_content">
                                          ...
                                          <span className="author_designation text-white">CEO At SoftTrade</span>
                                        </div>
                                      </div>
                                      <p className="mb-0 text-white">
                                        “As a CEO at SoftTrade I have been voice crying in the wilderness, trying to make requirements
                                        clear, use every minute to deliver the result, and not reinvent the wheel. Here at SoftTrade, I made that possible for the clients.”
                                      </p>
        ...
        <small className="iconbox_title">Blog</small>
                                    ...
                                    <div className="col-lg-6">
                                      <div className="megamenu_case megamenu_case1">
                                        ...
                                        <h4 className='text-black'>{resourcesMenuContent[selectedResources].heading}</h4>
                                        <img src={resourcesMenuContent[selectedResources].image} alt={selectedResources} width={300} />
                                        <Link onClick={clickHandler} className="megamenu_btn megamenu_btn_about text-center text-black rounded" to={resourcesMenuContent[selectedResources].link}>
                                          Read More
                                          <span className="btn_icon ms-1">
                                            <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              <path d="M13 1C13 0.447715 12.5523 0 12 0H3C2.44771 0 2 0.447715 2 1C2 1.55228 2.44771 2 3 2H11V10C11 10.5523 11.4477 11 12 11C12.5523 11 13 10.5523 13 10V1ZM1.70711 12.7071L12.7071 1.70711L11.2929 0.292893L0.292893 11.2929L1.70711 12.7071Z" fill="#fff" />
