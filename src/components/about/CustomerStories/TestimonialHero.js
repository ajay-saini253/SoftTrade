                        ...
                        <div className="col-xl-7 col-lg-6 py-3 py-lg-5 order-2 order-lg-1">
                            <div className="xb-hero">
                                ...
                                <Fade direction='up' triggerOnce={false} duration={1400}>
                                    <p className="text-muted fs-6 text-justify">
                                        By implementing <strong>SoftTrade Cloud-based ERP</strong> and <strong>Mobile ERP solutions</strong>, they achieved centralized control, real-time data synchronization, and full mobile accessibility — empowering their staff to manage operations on-the-go and make faster decisions.
                                    </p>
                                </Fade>
                                ...
                                <Fade direction='up' triggerOnce={false} duration={1800}>
                                    <blockquote className="bg-white p-4 rounded shadow mt-3">
                                        <p className="mb-0 fst-italic text-muted">
                                            “With SoftTrade's ERP, we’ve eliminated manual tracking and gained full control across locations. The mobile access is a game changer for our field team.”
                                        </p>
