...
import tImg1 from '../../../images/testimonial/img1.jpg';
...
const testimonial = [
    {
        ...
        tImg: tImg1,
        logo: icon1,
        Des: "SoftTrade streamlined our operations with their Cloud ERP. We've reduced manual tasks by 60% and improved team collaboration.",
        Name: 'Ankur Sharma',
    ...
    },
    {
        ...
        tImg: tImg3,
        logo: icon3,
        Des: "SoftTrade helped us transition from outdated tools to a powerful, centralized Web ERP. Everything is now seamless.",
        Name: 'Tarun Kapoor',
    ...
    },
    {
        ...
        tImg: tImg4,
        logo: icon4,
        Des: "We trusted SoftTrade for our custom CRM integration. The support and adaptability were outstanding.",
        Name: 'Neha Joshi',
    ...
    },
    {
        ...
        tImg: tImg2,
        logo: icon2,
        Des: "SoftTrade’s team truly understands business needs. Their scalable ERP helped us grow efficiently.",
        Name: 'Priya Anand',
            ...
            <div className="container">
                <div className="sa-tes_top pos-rel mb-60">
                    <div className="sec-title--two">
                        ...
                        <Fade direction='up' triggerOnce={false} duration={1200} delay={9}>
                            <div>
                                <p className="my-3">Discover how SoftTrade’s ERP and software solutions are transforming businesses across industries.</p>
                            </div>
                        </Fade>
                    </div>
