...
import gImg3 from '../../../images/gallery/1.jpg'
import gImg4 from '../../../images/gallery/2.jpg'
import gImg5 from '../../../images/gallery/1.jpg'
import gImg6 from '../../../images/gallery/3.jpg'
import gImg7 from '../../../images/gallery/4.jpg'
import gImg8 from '../../../images/gallery/4.jpg' 
import gImg9 from '../../../images/gallery/3.jpg'
import gImg10 from '../../../images/gallery/2.jpg'
import gImg11 from '../../../images/gallery/4.jpg'

const GallerySection = (props) => {
  return (
    <section className={`gallery  pt-50 pb-50 ${props.pClass}`}>
      <div className="container">
        <div className="sec-title--two text-center mb-60">
          <h2 className="title"> Our gallery</h2>
          <p className="text-muted fs-4 py-3">Explore stunning moments</p>
        </div>
