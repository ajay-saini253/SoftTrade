                        ...
                        <Fade direction="up" triggerOnce={false}>
                            <div className="mission-content pe-lg-4">
                                ...
                                <p className="mission-text py-3">
                                    At SoftTrade, our mission is to revolutionize how businesses manage their digital operations by providing user-friendly, reliable, and scalable software solutions.
                                </p>
                                <p className="mission-text py-3">
                    ...
                    <div className="col-lg-7 order-2 order-lg-1">
                        <Fade direction="up" triggerOnce={false}>
                            <div className="vision-content ps-lg-4">
                                ...
                                <p className="vision-text py-3">
                                    SoftTrade envisions a world where software is not just a tool, but a trusted partner in achieving excellence, efficiency, and digital transformation.
                                </p>
                            </div>
                        </Fade>
                    </div>
