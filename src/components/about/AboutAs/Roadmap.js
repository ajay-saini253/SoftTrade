    ...
    const roadmapData = [
        {
            quarter: "Q-1",
            year: "2009",
            title: "SoftTrade was founded",
            content:
                "SoftTrade started its journey in Jaipur, India with a small but passionate team of 4 people. From a modest office, we began offering software solutions tailored to local businesses.",
        },
        {
            quarter: "Q-2",
            year: "2012",
            ...
            content:
                "By 2012, SoftTrade had successfully delivered over 100 software solutions, including early versions of ERP and inventory systems for SMEs across Rajasthan.",
        },
        {
            quarter: "Q-3",
            year: "2015",
            ...
            content:
                "With growing demand, SoftTrade expanded its team to 30+ members and ventured into web-based ERP, hostel management systems, and custom CRM platforms.",
        },
        {
            quarter: "Q-4",
            year: "2018",
        ...
        },
        {
            ...
            content:
                "SoftTrade quickly adapted to remote support and development during COVID-19, helping businesses go digital with custom dashboards, attendance tracking, and mobile ERP apps.",
        },
        {
            quarter: "Q-2",
            year: "2023",
        ...
        },
        {
            ...
            title: "Present Day",
            content:
                "Today, SoftTrade is a team of over 70 professionals offering tailored ERP, CRM, and automation tools. With a client-first approach, we continue to deliver scalable, secure, and intuitive solutions globally.",
        },
    ];
