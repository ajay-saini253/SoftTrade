...
const Achievements = (props) => {
    ...
    return (
        <section className="award pt-50 pb-50 hero1-split">
                    ...
                    <div className="award-top  align-items-end mb-10">
                        <div className="sec-title--two sec-title--three mb-30">
                            ...
                            <Fade direction='up' triggerOnce={false} duration={1200} delay={9}>
                                <div>
                                    <h2 className="title wow skewIn py-4 text-black text-center" data-wow-delay="000ms" data-wow-duration="600ms">SoftTrade Software Awarded By</h2>
                                </div>
                            </Fade>
                        </div>
                         </div>
