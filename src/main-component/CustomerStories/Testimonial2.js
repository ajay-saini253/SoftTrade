    ...
    const testimonials = [
        {
            ...
            content1: "Our sales force needed real-time access to inventory and orders while on the move. SoftTrade's MobileERP enabled seamless mobile workflows and boosted our team’s productivity by 60%.",
            img:tImg1,
            img2:Img1,
            highlights: [
            ...
            },
        {
            ...
            content1: "We migrated from legacy software to SoftTrade's WebSuite ERP. The switch streamlined finance, HR, and logistics into one platform accessible via any browser.",
             img:tImg2,
            img2:Img2,
            highlights: [
    ...
    },
        {
            ...
            content1: "As we scaled globally, we needed a solution that scaled too. CloudCore ERP from SoftTrade gave us security, performance, and flexibility—all in the cloud.",
            img:tImg3,
            img2:Img3,
            highlights: [
             ...
             content2: "Thanks to SoftTrade’s cloud-first approach, we migrated our entire ecosystem with zero operational disruption. The platform’s automatic updates and data redundancy have given us the confidence to run mission-critical operations with peace of mind.",
        ...
        <section className="testimonial pt-50 pb-50">
            <div className="container">
                <div className="da-sec-titlte text-center mb-60">
                    <h2 className="title text-black fw-normal fs-2">Client Experiences with SoftTrade ERP Solutions</h2>
                </div>
