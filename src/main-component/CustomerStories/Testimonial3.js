    ...
    const testimonials = [
        {
            authorImg: tImg1,
            content:
                "“Most businesses are sitting on a data gold mine within their customer profiles. We use SoftTrade to get on customer interactions.”",
            name: "Laurie Leduc",
        ...
        },
        {
            authorImg: tImg2,
            content:
                "“The workflows we built in SoftTrade suite allowed us to achieve or exceed customer expectations in handling urgent issues.”",
        ...
        },
        {
            authorImg: tImg3,
            content:
                "“We love SoftTrade because their API allows us to explore ways to get customer data more personalized experience.”",
            name: "Sophia Turner",
