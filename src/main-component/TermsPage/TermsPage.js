                            ...
                            <div className="row mt-none-30 align-items-center">
                                <div className="col-lg-8 mt-30">
                                    <div className="page-title-box">
                                        ...
                                        <h2 className="title">SoftTrade website terms & <br /> conditions your access and <br /> usage rights</h2>
          ...
          <div className="page-title-box text-center">
            ...
            <Fade direction="up" triggerOnce={false} duration={1400} delay={9}>
              <span className="wow fadeInUp text-justify">
                These Terms and Conditions govern the use of all services, content, and software provided by SoftTrade across mobile, desktop, and web platforms. Please read them carefully before using our site.
              </span>
            </Fade>
          </div>
        </div>
        <div className="col-lg-5 py-lg-3 py-3 order-1 order-lg-2">
          <div className="sd-right-img pos-rel">
            <Fade direction="up" triggerOnce={false} duration={1200} delay={9}>
              <img className="wow fadeInRight rounded-5" src={bImg1} alt="SoftTrade Terms & Conditions Hero" />
            </Fade>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-11">
          ...
          <div className="item-details-widget">
            ...
            <p>All content on this website—including text, graphics, logos, and trademarks—is the property of SoftTrade or its licensors, protected by intellectual property laws. Unauthorized use or duplication may lead to legal action. Third-party logos and content are owned by their respective entities.</p>
          </div>
          ...
          <div className="item-details-widget">
            ...
            <p>We may link to third-party websites for convenience. However, SoftTrade is not responsible for their content or privacy practices. Use them at your own risk.</p>
          </div>
          ...
          <div className="item-details-widget">
            ...
            <p>SoftTrade values your privacy and processes personal information according to our <Link onClick={ClickHandler} to="/privacy-policy" className="details-link">Privacy Policy</Link>. We encourage you to review it for more details about how we collect, use, and protect your data.</p>
          </div>

          <div className="item-details-widget">
            <h2 className="item_details_info_title">5. Disclaimer</h2>
            <p>The information provided on this website is for general informational purposes only. While we strive for accuracy, SoftTrade makes no guarantees of completeness, accuracy, or usefulness. We disclaim all liability for errors or omissions in the content.</p>
          ...
          <div className="item-details-widget">
            ...
            <p>To the maximum extent permitted by law, SoftTrade is not liable for any indirect, incidental, or consequential damages—whether in contract or tort—including loss of data, revenue, or profits. This limitation may not apply in jurisdictions that prohibit certain exclusions.</p>
          </div>
