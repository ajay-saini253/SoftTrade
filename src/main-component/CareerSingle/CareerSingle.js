                            ...
                            <div className="row mt-none-30 align-items-center">
                                <div className="col-lg-8 mt-30">
                                    <div className="page-title-box">
                                        ...
                                        <h2 className="title">Be a part of shaping the <br /> future & career opportunities <br /> at SoftTrade today.</h2>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="cs-contact-wrap cs-contact-form cd-contact-form">
                                        ...
                                        <p className="xb-content">SoftTrade doesn’t accept unsolicited resumes from recruiters or employment agencies.</p>
