                            ...
                            <div className="row mt-none-30 align-items-center">
                                <div className="col-lg-8 mt-30">
                                    <div className="page-title-box">
                                        ...
                                        <h2 className="title">SoftTrade website privacy <br /> policy your access and <br /> usage rights</h2>
          ...
          <div className="page-title-box text-center">
            ...
            <Fade direction="up" triggerOnce={false} duration={1400} delay={9}>
              <span className="wow fadeInUp text-justify">
                At SoftTrade, your privacy is our top priority. This policy explains how we collect, use, and protect your data across all our platforms — including mobile, desktop, cloud, and web ERP solutions.
              </span>
            </Fade>
          </div>
        </div>
        <div className="col-lg-5 py-lg-3 py-3 order-1 order-lg-2">
          <div className="sd-right-img pos-rel">
            <Fade direction="up" triggerOnce={false} duration={1200} delay={9}>
              <img className="wow fadeInRight rounded-5" src={bImg1} alt="SoftTrade Privacy Policy Hero" />
            </Fade>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-11">
          ...
          <div className="item-details-widget">
            ...
            <p>SoftTrade uses secure cloud storage, firewalls, access control, and encryption to prevent unauthorized access or loss of your data.</p>
          </div>
