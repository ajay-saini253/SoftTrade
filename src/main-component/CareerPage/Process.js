                                            ...
                                            <Accordion open={open} toggle={toggle} className='accordion_box clearfix list-unstyled'>
                                                <AccordionItem className='block'>
                                                    <AccordionHeader targetId="1" className='acc-btn'>
                                                        <span className="number">01</span> _Apply to SoftTrade
                                                ...
                                                <AccordionItem className='block'>
                                                    ...
                                                    <AccordionBody accordionId="2" className='acc_body'>
                                                        <div className="content">
                                                            <p>Our team will review your profile to match your skills with current opportunities at SoftTrade. If shortlisted, we’ll get in touch soon.</p>
                                                        </div>
                                                    </AccordionBody>
                                                </AccordionItem>
                                                ...
                                                <AccordionItem className='block'>
                                                    ...
                                                    <AccordionBody accordionId="3" className='acc_body'>
                                                        <div className="content">
                                                            <p>Engage with our technical experts and HR team to discuss your expertise, values, and alignment with SoftTrade’s mission.</p>
                                                        </div>
                                                    </AccordionBody>
                                                </AccordionItem>
                                                ...
                                                <AccordionItem className='block'>
                                                    <AccordionHeader targetId="5" className='acc-btn'>
                                                        <span className="number">05</span> _Welcome to SoftTrade!
                                                        <span className="arrow"></span>
                                                    </AccordionHeader>
                    ...
                    <div className="col-lg-6 mt-30">
                        <div className="cp-process">
                            <div className="xb-img">
                                <img src={rImg} alt="SoftTrade hiring illustration" />
                            </div>
                        </div>
                    </div>
