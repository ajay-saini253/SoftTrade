...
const partnerLinks = [
  { label: "Partner Overview", to: "/download/partner-overview" },
  { label: "Partner Login", to: "/download/partner-login" },
  { label: "Partner Overview", to: "/download/partner-overview" },
  { label: "Partner Login", to: "/download/partner-login" },
  { label: "Partner Overview", to: "/download/partner-overview" },
  { label: "Partner Login", to: "/download/partner-login" },
              ...
              <nav className="main-menu collapse navbar-collapse desktop_header_menu-top">
                ...
                <ul className='header_menu_border-top'>
                  ...
                  <li className="menu-item-has-children">
                    {/* {
                      partnerLinks.map((value,key)=>{
                        return(
                          )
                          })
                          } 
                      */}
                    <Link onClick={clickHandler} to={`/download/partner-overview`}>Download</Link>
                    <ul className="submenu">
                      {
                        partnerLinks.map((value,key)=>{
                          return(
                            <li key={key} ><Link onClick={clickHandler} to={value.to}><span>{value.label}</span></Link></li>
                          )
                        })
                      }
